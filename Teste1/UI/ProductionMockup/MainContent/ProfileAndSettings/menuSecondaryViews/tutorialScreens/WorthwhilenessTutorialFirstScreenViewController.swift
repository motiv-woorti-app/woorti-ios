...
class WorthwhilenessTutorialFirstScreenViewController: GenericViewController {
    ...
    override func viewDidLoad() {
        ...
        let prodText = NSLocalizedString("Productivity", comment: "")
        let healthText = NSLocalizedString("Fitness", comment: "")
        let relaxText = NSLocalizedString("Enjoyment", comment: "")
        
        MotivFont.motivBoldFontFor(text: prodText, label: self.ProductiveLabel, size: 15)
        self.ProductiveLabel.textColor = MotivColors.WoortiYellow
        MotivFont.motivBoldFontFor(text: healthText, label: self.healthLabel, size: 15)
        self.healthLabel.textColor = MotivColors.WoortiGreen
        MotivFont.motivBoldFontFor(text: relaxText, label: self.RelaxingLabel, size: 15)
    ...
    func loadSaveButton(){
        ...
        MotivFont.motivBoldFontFor(key: "Next", comment: "", button: nextButton, size: 15)
