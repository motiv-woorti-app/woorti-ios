...
class SetHomeOrWorkViewController: GenericViewController {
    ...
    private func loadOptions() {
        ...
        case .Home:
            MotivFont.motivRegularFontFor(text: "Define the location of your home to get trips faster", label: self.label, size: 17)
            self.textView.text = MotivUser.getInstance()?.homeAddress ?? ""
        case .Work:
            MotivFont.motivRegularFontFor(text: "Define the location of your work to get trips faster", label: self.label, size: 17)
