...
class ProfileEditUserViewController: GenericViewController {
    ...
    override func viewDidLoad() {
        ...
        MotivFont.motivRegularFontFor(key: "Change_Photo", comment: "", label: changePhotoLabel, size: 15)
        MotivFont.motivRegularFontFor(key: "Name", comment: "", label: nameLabel, size: 15)
        MotivFont.motivRegularFontFor(key: "Email", comment: "", label: emailLabel, size: 15)
